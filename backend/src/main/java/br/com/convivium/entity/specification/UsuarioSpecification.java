...
public class UsuarioSpecification {
    ...
    public static Specification<User> filtrarPorNomeECpfComEmpresa(UsuarioFiltroDTO filtro, Long empresaId) {
        return (root, query, cb) -> {
            Predicate predicate = cb.conjunction();

            // Filtro por empresa obrigatório
            predicate = cb.and(predicate, cb.equal(root.get("empresa").get("id"), empresaId));
